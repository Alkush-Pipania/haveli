...
export default function Listing() {
    ...
    <main>
      ...
      <div className="fixed top-[13%] right-[3%] z-20 bg-white cursor-pointer rounded-full w-12 h-12 flex justify-center items-center" onClick={()=>{navigator.clipboard.writeText(window.location.href); setShareLinkCopied(true); setTimeout(()=>{setShareLinkCopied(false)},2000)}}>
      ...
      <div className="m-4 flex flex-col md:flex-row md-flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className="bg-white w-full  ">
          ...
          {listing.userRef  !== auth.currentUser ?. uid && !contactLandlord && (<div className="mt-9">
          <button onClick={()=>setContactLandlord(true)} className="px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-800 focus:shadow-lg w-full text-center transition ease-in duration-150">Contact Landlord</button>
          </div>)}
          {contactLandlord && (
        ...
        <div className="  w-full h-[200px] lg:h-[400px]  z-10 overflow-x-hidden mt-6 lg:mt-0 md:ml-2">
